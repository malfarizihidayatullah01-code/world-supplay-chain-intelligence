...
<div class="container-fluid py-4 px-xl-5 fade-in-up">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            ...
            <p class="text-secondary mb-0" style="font-size: 1rem;">Update account details for {{ $user->name }}.</p>
        </div>
                ...
                <div class="saas-form-card">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="saas-input" value="{{ old('name', $user->name) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="saas-label">Email Address</label>
                            <input type="email" name="email" class="saas-input" value="{{ old('email', $user->email) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="saas-label">Password</label>
                            <input type="password" name="password" class="saas-input" placeholder="Leave blank to keep current password">
                            <div class="form-text mt-2" style="font-size: 0.75rem; color: #94A3B8;">Only fill this if you want to change the password.</div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="saas-action-bar">
                    ...
                    <button type="submit" class="saas-btn-submit">Save Changes</button>
                </div>
            </div>
        </div>
