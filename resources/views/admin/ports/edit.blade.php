...
<div class="container-fluid py-4" style="max-width: 800px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold text-dark">Edit Port</h4>
    ...
    <div class="admin-card card p-4">
        ...
        <form method="POST" action="{{ route('admin.ports.update', $port->id) }}">
            ...
            <h6 class="fw-bold mb-4 border-bottom pb-2">Port Details</h6>
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-6">
                    ...
                    <input type="number" step="any" name="latitude" class="form-control" value="{{ old('latitude', $port->latitude) }}" placeholder="e.g. -6.1431" required>
                    <div class="form-text" style="font-size: 0.75rem;">Range: -90 to 90</div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Longitude</label>
                    <input type="number" step="any" name="longitude" class="form-control" value="{{ old('longitude', $port->longitude) }}" placeholder="e.g. 106.8706" required>
                    <div class="form-text" style="font-size: 0.75rem;">Range: -180 to 180</div>
                </div>
            </div>

            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('admin.ports.index') }}" class="btn btn-light border px-4" style="border-radius: 8px;">Cancel</a>
