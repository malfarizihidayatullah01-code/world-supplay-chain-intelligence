        ...
        <form method="POST" action="{{ route('admin.articles.store') }}">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-12">
                    ...
                    <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Contoh: Dampak Krisis di Laut Merah..." required>
                </div>
                
                <div class="col-md-6">
                    <label class="form-label">Kategori</label>
                    <input type="text" name="category" class="form-control" value="{{ old('category') }}" placeholder="Contoh: Shipping, Economy, Weather">
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="tags" class="form-control" value="{{ old('tags') }}" placeholder="Contoh: Laut Merah, Logistik, Krisis">
                </div>

                <div class="col-md-12">
                    <label class="form-label">Isi Artikel</label>
                    <textarea name="content" class="form-control" rows="8" placeholder="Tuliskan analisis Anda di sini..." required>{{ old('content') }}</textarea>
                </div>
