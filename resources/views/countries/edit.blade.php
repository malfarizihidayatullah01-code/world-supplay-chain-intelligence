...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="m-0">Edit Country: {{ $country->country_name }}</h2>
            ...
            <form action="{{ route('countries.update', $country->id) }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="iso2_code" class="form-control" maxlength="2" value="{{ old('iso2_code', $country->iso2_code) }}" required>
                    </div>
                    
                    <div class="col-md-3">
                        <label class="form-label fw-bold">ISO3 Code <span class="text-danger">*</span></label>
                        <input type="text" name="iso3_code" class="form-control" maxlength="3" value="{{ old('iso3_code', $country->iso3_code) }}" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-bold">Capital City <span class="text-danger">*</span></label>
                        <input type="text" name="capital_city" class="form-control" value="{{ old('capital_city', $country->capital_city) }}" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-bold">Region <span class="text-danger">*</span></label>
                        <input type="text" name="region" class="form-control" value="{{ old('region', $country->region) }}" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-bold">Sub Region</label>
                        <input type="text" name="sub_region" class="form-control" value="{{ old('sub_region', $country->sub_region) }}">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label fw-bold">Currency Code</label>
                        <input type="text" name="currency_code" class="form-control" maxlength="3" value="{{ old('currency_code', $country->currency_code) }}">
                    </div>
                ...
                <div class="mt-4 text-end">
                    <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save"></i> Update Country</button>
                </div>
            </form>
        </div>
    </div>
