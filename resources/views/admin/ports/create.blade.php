            ...
            <div class="row g-4 mb-5">
                <div class="col-md-5">
                    <div class="mb-4">
                        ...
                        <input type="number" step="any" name="latitude" id="inputLat" class="form-control" value="{{ old('latitude', '-6.1431') }}" placeholder="e.g. -6.1431" required>
                        <div class="form-text" style="font-size: 0.75rem;">Range: -90 to 90</div>
                    </div>
                    <div>
                        <label class="form-label">Longitude</label>
                        <input type="number" step="any" name="longitude" id="inputLng" class="form-control" value="{{ old('longitude', '106.8706') }}" placeholder="e.g. 106.8706" required>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Initialize coordinates (default to Jakarta if empty)
